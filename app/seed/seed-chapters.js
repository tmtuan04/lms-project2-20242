...
async function main() {
  ...
  const chapter1 = await prisma.chapter.create({
    data: {
      title: "Introduction",
      description:
        "Get started with web development fundamentals. Learn about the course structure and what you'll achieve.",
  ...
  const chapter3 = await prisma.chapter.create({
    data: {
      title: "CSS Basics",
      description:
        "Understand CSS fundamentals, including selectors, properties, and styling techniques.",
      videoUrl: "https://youtu.be/your-video-id",
      courseId: courseId,
      attachments: {
        create: [
